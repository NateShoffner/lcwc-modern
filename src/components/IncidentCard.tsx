            ...
            <Card.Text>
                ...
                <div className="row">
                    <div className="col-sm-12 col-md-12 col-lg-6 mb-3">
                        <p className='fw-bold mb-auto'><FontAwesomeIcon icon={faLocationPin} /> Location:</p>
                        <p className='mb-auto'>{incident.intersection}</p>
                        <p className='mb-auto'>{incident.municipality}</p>
                    </div>
                    <div className="col-sm-12 col-md-12 col-lg-6 mb-3">
                        <p className='fw-bold mb-auto'><FontAwesomeIcon icon={faCalendarAlt} /> Date/Time (EST):</p>
                ...
                <div className="row">
                    <div className="col-sm-12 col-md-12 col-lg-6 mb-3">
                        <p className='fw-bold mb-auto'><FontAwesomeIcon icon={faClock} /> Agency:</p>
                ...
                <Card.Footer>
                    <div className="row">
                        <div className="col-sm-12 col-md-12 col-lg-5">
                            <small className="text-muted"><FontAwesomeIcon icon={faClock} /> Updated: Unknown</small>
                        </div>
                        <div className="col-sm-12 col-md-6 col-lg-3">
                            <small className="text-muted"><FontAwesomeIcon icon={faArrowUpWideShort} /> Priority: {incident.priority ?? 'N/A' }</small>
                        </div>
                        <div className="col-sm-12 col-md-6 col-lg-4">
                            <small className="text-muted"><FontAwesomeIcon icon={faHashtag} /> {incident.number ?? 'N/A'}</small>
                        </div>
                    </div>
                </Card.Footer>
            </Card>
